...
angular.module('sc.moments',[])
  .controller('MomentsCtrl', function($scope,$ionicActionSheet,$stateParams,$state){
    $scope.now =0;
    ...
    $scope.newPost = function () {
      $ionicActionSheet.show({
        ...
        titleText: 'Share new Moments',
        buttonClicked: function (index) {
          if (index == 0) {
            $state.go('moments.newPost');
          }
          if (index == 1) {
            $state.go('moments.newPost');
          }
  ...
  .controller('SocialNewPostCtrl', function ($scope, $state, $http, $stateParams,
