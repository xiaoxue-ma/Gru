    ...
    e.AmSerialChart = e.Class({
        inherits: e.AmRectangularChart, construct: function (a) {
            ...
            if (!this.wheelBusy) {
                ...
                var h = this.chartData.length, l = this.lastTime, g = this.firstTime;
                0 > a ? d ? (h = this.endTime - this.startTime, d = this.startTime + c * f, f = this.endTime + e * f, 0 < e && 0 < c && f >= l && (f = l, d = l - h), this.zoomToDates(new Date(d), new Date(f))) : (0 < e && 0 < c && this.end >= h - 1 && (c = e = 0), d = this.start +
                c, f = this.end + e, this.zoomToIndexes(d, f)) : d ? (h = this.endTime - this.startTime, d = this.startTime - c * f, f = this.endTime - e * f, 0 < e && 0 < c && d <= g && (d = g, f = g + h), this.zoomToDates(new Date(d), new Date(f))) : (0 < e && 0 < c && 1 > this.start && (c = e = 0), d = this.start - c, f = this.end - e, this.zoomToIndexes(d, f))
            }
        ...
        getEndTime: function (a) {
            ...
            var k = this.chartData, f = this.categoryAxis;
            if (e.ifArray(k) && (a != this.startTime || b != this.endTime)) {
                var h = f.minDuration(),
                    d = this.firstTime, l = this.lastTime;
                a || (a = d, isNaN(c) || (a = l - c));
                b || (b = l);
                a > l && (a = l);
                b < d && (b = d);
                ...
                this.endTime = b;
                c = k.length - 1;
                h = this.getClosestIndex(k, "time", a, !0, 0, c);
                k = this.getClosestIndex(k, "time", b, !1, h, c);
                f.timeZoom(a, b);
                f.zoom(h, k);
                this.start = e.fitToBounds(h, 0, c);
                this.end = e.fitToBounds(k, 0, c);
                this.zoomAxesAndGraphs();
                this.zoomScrollbar();
                a != d || b != l ? this.showZB(!0) : this.showZB(!1);
        ...
        updateAfterValueZoom: function () {
            ...
            a.enabled && a.dragger && (a.dragger.stop(), b.parseDates && !b.equalSpacing ? a.timeZoom(this.startTime, this.endTime) : a.zoom(this.start, this.end), this.updateScrollbar = !0)
            ...
            var a = 0, b = this.valueAxes.length, c = this.graphs.length, d, e, k = !1, h, l;
            for (l = 0; l < b; l++) {
                e = this.valueAxes[l];
                var g = e.stackType;
                if ("100%" == g || "regular" == g)for (k = !1, h = 0; h < c; h++)d = this.graphs[h], d.tcc = 1, d.valueAxis == e && "column" == d.type && (!k && d.stackable && (a++, k = !0), (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
                if ("none" == g || "3d" == g) {
                    k = !1;
                    for (h = 0; h < c; h++)d = this.graphs[h], d.valueAxis == e && "column" == d.type && (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) : d.hidden || (k = !0, d.tcc = 1, d.columnIndex = 0));
                    k && 0 === a && (a = 1)
                }
                if ("3d" == g) {
                    e = 1;
                    for (l = 0; l < c; l++)d = this.graphs[l], d.newStack && e++, d.depthCount =
                        e, d.tcc = a;
                    a = e
                }
            }
            ...
            if (this.prevStartTime !=
                this.startTime || this.prevEndTime != this.endTime) {
                var a = {type: "zoomed"};
        ...
        }, getClosestIndex: function (a, b, c, d, e, k) {
            0 > e && (e = 0);
            k > a.length - 1 && (k = a.length - 1);
            var h = e + Math.round((k -
                e) / 2), l = a[h][b];
            return c == l ? h : 1 >= k - e ? d ? e : Math.abs(a[e][b] - c) < Math.abs(a[k][b] - c) ? e : k : c == l ? h : c < l ? this.getClosestIndex(a, b, c, d, e, h) : this.getClosestIndex(a, b, c, d, h, k)
            ...
            if (b) {
                var c = ["value", "open", "low", "high", "close"], d = "value open low high close average sum count".split(" "),
                    f = b.valueAxis, k = this.chartData, h = b.numberFormatter;
                h || (h = this.nf);
                for (var l = 0; l < c.length; l++) {
                    for (var g = c[l], n = 0, p = 0, q, m, w, y, v, r = 0, t = 0, A, u, x, B, C, I = this.start; I <= this.end; I++) {
                        var z = k[I];
                        if (z && (z = z.axes[f.id].graphs[b.id])) {
                            if (z.values) {
                                ...
                                if (!isNaN(D)) {
                                    ...
                                    if (isNaN(y) || y < D)y = D;
                                    v = e.getDecimals(n);
                                    var F = e.getDecimals(D), n = n + D, n = e.roundTo(n, Math.max(v, F));
                                    p++;
                                    v = n / p
                                }
                            }
                    ...
                    r = {open: A, close: u, high: B, low: x, average: C, sum: r, count: t};
                    a = e.formatValue(a, {
                        open: q,
                        close: m,
                        high: y,
                        ...
                        sum: n,
                        count: p
                    }, d, h, g + "\\.", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
                    a = e.formatValue(a, r, d, this.pf, "percents\\." + g + "\\.")
                }
            }
            ...
            if (-1 != a.indexOf("[[category]]")) {
                ...
                if (this.categoryAxis.parseDates) {
                    var k = this.balloonDateFormat, h = this.chartCursor;
                    h && (k = h.categoryBalloonDateFormat);
                    -1 != a.indexOf("[[category]]") && (k = e.formatDate(f, k, this), -1 != k.indexOf("fff") && (k = e.formatMilliseconds(k, f)), f = k)
                }
            ...
            f || (f = this.nf);
            k = b.graph.valueAxis;
            (h = k.duration) && !isNaN(b.values.value) && (h = e.formatDuration(b.values.value, h, "", k.durationUnits,
                k.maxInterval, f), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), h));
            "date" == k.type && (k = e.formatDate(new Date(b.values.value), d.dateFormat, this), h = RegExp("\\[\\[value\\]\\]", "g"), a = a.replace(h, k), k = e.formatDate(new Date(b.values.open), d.dateFormat, this), h = RegExp("\\[\\[open\\]\\]", "g"), a = a.replace(h, k));
            d = "value open low high close total".split(" ");
            k = this.pf;
            a = e.formatValue(a, b.percents, d, k, "percents\\.");
            a = e.formatValue(a, b.values, d, f, "", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers);
            a = e.formatValue(a, b.values, ["percents"], k);
...
(function () {
    var e = window.AmCharts;
    e.Cuboid = e.Class({
        construct: function (a, b, c, d, e, k, h, l, g, n, p, q, m, w, y, v, r) {
            this.set = a.set();
            this.container = a;
            this.h = Math.round(c);
            this.w = Math.round(b);
            ...
            this.rotate = m;
            this.bcn = r;
            m ? 0 > b && 0 === p && (p = 180) : 0 > c && 270 == p && (p = 90);
            ...
            var a = this.set;
            a.clear();
            var b = this.container, c = b.chart, d = this.w, f = this.h, k = this.dx, h = this.dy, l = this.colors, g = this.alpha, n = this.bwidth, p = this.bcolor, q = this.balpha, m = this.gradientRotation, w = this.cornerRadius, y = this.dashLength, v = this.pattern, r = this.topRadius, t = this.bcn, A = l, u = l;
            "object" == typeof l && (A = l[0], u = l[l.length - 1]);
            var x, B, C, I, z, D, F, L, M, Q = g;
            v && (g = 0);
            var E, G, H, J, K = this.rotate;
            if (0 < Math.abs(k) || 0 < Math.abs(h))if (isNaN(r))F = u, u = e.adjustLuminosity(A, -.2), u = e.adjustLuminosity(A, -.2), x = e.polygon(b, [0, k, d + k, d, 0], [0, h, h, 0, 0],
                u, g, 1, p, 0, m), 0 < q && (M = e.line(b, [0, k, d + k], [0, h, h], p, q, n, y)), B = e.polygon(b, [0, 0, d, d, 0], [0, f, f, 0, 0], u, g, 1, p, 0, m), B.translate(k, h), 0 < q && (C = e.line(b, [k, k], [h, h + f], p, q, n, y)), I = e.polygon(b, [0, 0, k, k, 0], [0, f, f + h, h, 0], u, g, 1, p, 0, m), z = e.polygon(b, [d, d, d + k, d + k, d], [0, f, f + h, h, 0], u, g, 1, p, 0, m), 0 < q && (D = e.line(b, [d, d + k, d + k, d], [0, h, f + h, f], p, q, n, y)), u = e.adjustLuminosity(F, .2), F = e.polygon(b, [0, k, d + k, d, 0], [f, f + h, f + h, f, f], u, g, 1, p, 0, m), 0 < q && (L = e.line(b, [0, k, d + k], [f, f + h, f + h], p, q, n, y)); else {
                var N, O, P;
                K ? (N = f / 2, u = k / 2, P = f / 2, O =
                    d + k / 2, G = Math.abs(f / 2), E = Math.abs(k / 2)) : (u = d / 2, N = h / 2, O = d / 2, P = f + h / 2 + 1, E = Math.abs(d / 2), G = Math.abs(h / 2));
                H = E * r;
                J = G * r;
                .1 < E && .1 < E && (x = e.circle(b, E, A, g, n, p, q, !1, G), x.translate(u, N));
                .1 < H && .1 < H && (F = e.circle(b, H, e.adjustLuminosity(A, .5), g, n, p, q, !1, J), F.translate(O, P))
            }
            g = Q;
            1 > Math.abs(f) && (f = 0);
            1 > Math.abs(d) && (d = 0);
            !isNaN(r) && (0 < Math.abs(k) || 0 < Math.abs(h)) ? (l = [A], l = {
                fill: l,
                stroke: p,
                "stroke-width": n,
                "stroke-opacity": q,
                "fill-opacity": g
            }, K ? (g = "M0,0 L" + d + "," + (f / 2 - f / 2 * r), n = " B", 0 < d && (n = " A"), e.VML ? (g += n + Math.round(d -
    ...
    e.CategoryAxis = e.Class({
        inherits: e.AxisBase, construct: function (a) {
            ...
            if (e.ifArray(a)) {
                ...
                var d = this.start, f = this.labelFrequency, k = 0, h = this.end - d + 1, l = this.gridCountR, g = this.showFirstLabel, n = this.showLastLabel, p, q, m = "", m = e.extractPeriod(this.minPeriod), w = e.getPeriodDuration(m.period,
                    m.count), y, v, r, t;
                y = this.rotate;
                p = this.firstDayOfWeek;
                q = this.boldPeriodBeginning;
                b = e.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * w), this.minPeriod, 1, p).getTime();
                this.firstTime = c.firstTime;
                this.endTime > b && (this.endTime = b);
                t = this.minorGridEnabled;
                var A = this.gridAlpha, u, x = 0, B = 0;
                if (this.widthField)for (b = 0; b < this.data.length; b++)if (u = this.data[b]) {
                    var C = Number(this.data[b].dataContext[this.widthField]);
                    isNaN(C) || (x += C, u.widthValue = C)
                }
                if (this.parseDates && !this.equalSpacing)this.lastTime = a[a.length -
                1].time, this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * w), this.minPeriod, 1, p).getTime(), this.timeDifference = this.endTime - this.startTime, this.parseDatesDraw(); else if (!this.parseDates) {
                    if (this.cellWidth = this.getStepWidth(h), h < l && (l = h), k += this.start, this.stepWidth = this.getStepWidth(h), 0 < l)for (l = Math.floor(h / l), h = this.chooseMinorFrequency(l), m = k, m / 2 == Math.round(m / 2) && m--, 0 > m && (m = 0), u = 0, this.end - m + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = m; b <= this.end + 2; b++) {
                        q = !1;
                        0 <= b && b < this.data.length ? (v = this.data[b], m = v.category, q = v.forceShow) : m = "";
                        if (t && !isNaN(h))if (b / h == Math.round(b / h) || q)b / l == Math.round(b / l) || q || (this.gridAlpha = this.minorGridAlpha, m = void 0); else continue; else if (b / l != Math.round(b / l) && !q)continue;
                        p = this.getCoordinate(b - k);
                        r = 0;
                        "start" == this.gridPosition && (p -= this.cellWidth / 2, r = this.cellWidth / 2);
                        q = !0;
                        a = r;
                        "start" == this.tickPosition && (a = 0, q = !1, r = 0);
                        if (b == d && !g || b == this.end && !n)m = void 0;
                        Math.round(u / f) != u / f && (m = void 0);
                        u++;
                        C = this.cellWidth;
                        y && (C = NaN, this.ignoreAxisWidth || !c.autoMargins) && (C = "right" == this.position ? c.marginRight : c.marginLeft, C -= this.tickLength + 10);
                        this.labelFunction && v && (m = this.labelFunction(m, v, this));
                        m = e.fixBrakes(m);
                        w = !1;
                        this.boldLabels && (w = !0);
                        b > this.end && "start" == this.tickPosition && (m = " ");
                        this.rotate && this.inside && (r = -2);
                        isNaN(v.widthValue) || (v.percentWidthValue = v.widthValue / x * 100, C = this.rotate ? this.height * v.widthValue / x : this.width * v.widthValue / x, p = B, B += C, r = C / 2);
                        r = new this.axisItemRenderer(this, p, m, q, C, r, void 0, w, a, !1, v.labelColor, v.className);
                        r.serialDataItem = v;
                        this.pushAxisItem(r);
                        this.gridAlpha = A
                    }
                    ...
                    b < w && (f = m.period, y = m.count, b = w);
                    v = f;
                    "WW" == v && (v = "DD");
                    this.stepWidth = this.getStepWidth(h);
                    l = Math.ceil(this.timeDifference / b) + 1;
                    w = e.resetDateToMin(new Date(this.startTime - b), f, y, p).getTime();
                    this.cellWidth = this.getStepWidth(h);
                    m = Math.round(w / b);
                    d = -1;
                    m / 2 == Math.round(m / 2) && (d = -2, w -= b);
                    m = this.start;
                    m / 2 == Math.round(m / 2) && m--;
                    0 > m && (m = 0);
                    A = this.end + 2;
                    ...
                    u = m;
                    if (this.data[m].time != e.resetDateToMin(new Date(this.data[m].time), f, y, p).getTime())for (p = 0, a = w, b = m; b < A; b++)h = this.data[b].time, this.checkPeriodChange(f, y, h, a) && (p++, 2 <= p && (u = b, b = A), a = h);
                    t && 1 < y && (h = this.chooseMinorFrequency(y),
                        e.getPeriodDuration(f, h));
                    if (0 < this.gridCountR)for (b = m; b < A; b++)if (h = this.data[b].time, this.checkPeriodChange(f, y, h, w) && b >= u) {
                        p = this.getCoordinate(b - this.start);
                        t = !1;
                        this.nextPeriod[v] && (t = this.checkPeriodChange(this.nextPeriod[v], 1, h, w, v));
                        w = !1;
                        t && this.markPeriodChange ? (t = this.dateFormatsObject[this.nextPeriod[v]], w = !0) : t = this.dateFormatsObject[v];
                        m = e.formatDate(new Date(h), t, c);
                        if (b == d && !g || b == l && !n)m = " ";
                        B ? B = !1 : (q || (w = !1), p - this.previousPos > this.safeDistance * Math.cos(this.labelRotationR * Math.PI /
                        180) && (this.labelFunction && (m = this.labelFunction(m, new Date(h), this, f, y, r)), this.boldLabels && (w = !0), r = new this.axisItemRenderer(this, p, m, void 0, void 0, void 0, void 0, w), t = r.graphics(), this.pushAxisItem(r), t = t.getBBox().width, e.isModern || (t -= p), this.previousPos = p + t));
                        r = w = h
                    }
                }
                for (b = 0; b < this.data.length; b++)if (u = this.data[b])this.parseDates && !this.equalSpacing ? (g = u.time, n = this.cellWidth, "MM" == this.minPeriod && (n = 864E5 * e.daysInMonth(new Date(g)) * this.stepWidth, u.cellWidth = n), g = Math.round((g - this.startTime) *
                this.stepWidth + n / 2)) : g = this.getCoordinate(b - k), isNaN(u.widthValue) || (u.percentWidthValue = u.widthValue / x * 100, g = this.rotate ? this.height * u.widthValue / x : this.width * u.widthValue / x), u.x[this.id] = g;
                x = this.guides.length;
                for (b = 0; b < x; b++)g = this.guides[b], q = l = l = t = d = NaN, n = g.above, g.toCategory && (l = c.getCategoryIndexByValue(g.toCategory), isNaN(l) || (d = this.getCoordinate(l - k), g.expand && (d += this.cellWidth / 2), r = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, g), this.pushAxisItem(r, n))), g.category && (q = c.getCategoryIndexByValue(g.category),
                isNaN(q) || (t = this.getCoordinate(q - k), g.expand && (t -= this.cellWidth / 2), l = (d - t) / 2, r = new this.axisItemRenderer(this, t, g.label, !0, NaN, l, g), this.pushAxisItem(r, n))), q = c.dataDateFormat, g.toDate && (g.toDate = e.getDate(g.toDate, q), this.equalSpacing ? (l = c.getClosestIndex(this.data, "time", g.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(l) || (d = this.getCoordinate(l - k))) : d = (g.toDate.getTime() - this.startTime) * this.stepWidth, r = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, g), this.pushAxisItem(r, n)), g.date && (g.date =
                    ...
                    n), g.graphics = t, t.index = b, g.balloonText && this.addEventListeners(t, g))
            }
            this.axisCreated = !0;
            c = this.x;
            k = this.y;
            this.set.translate(c, k);
            this.labelsSet.translate(c, k);
            this.labelsSet.show();
            this.positionTitle();
            ...
            this.parseDates && !this.equalSpacing ?
                (a = this.startTime + Math.round(a / f) - this.minDuration() / 2, c = c.getClosestIndex(b, "time", a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= f / 2), c = this.start + Math.round(a / f));
            var c = e.fitToBounds(c, 0, b.length - 1), k;
            b[c] && (k = b[c].x[this.id]);
            d ? k > this.height + 1 && c-- : k > this.width + 1 && c--;
            0 > k && c++;
