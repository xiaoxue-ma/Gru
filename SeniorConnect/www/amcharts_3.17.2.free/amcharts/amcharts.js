  ...
  d.AxisBase = d.Class({
    ...
    getBBox: function () {
      ...
      if (0 < this.gridCountR)for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
        ...
        } else this.rotate ? (h += this.x - this.viX, "date" == this.type && "middle" == this.gridPosition && (L = -y * this.stepWidth / 2)) : h = "date" == this.type ? this.axisWidth - h + (this.y - this.viY) : h + (this.y - this.viY);
        f = !1;
  ...
  d.ValueAxis = d.Class({
    inherits: d.AxisBase, construct: function (a) {
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
        ...
        this.exponential = !1;
        for (g = f; g < r; g += p)v = d.roundTo(this.step *
        g + this.min, u), -1 != String(v).indexOf("e") && (this.exponential = !0);
        ...
        if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR =
          this.autoRotateAngle), g = f; g < r; g += p)if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)if (isNaN(w) || Number(d.toFixed(c, w)) == c) {
          ...
          if (c == this.baseValue && "radar" != a.type) {
            ...
            I && (f = d.fitToBounds(2 * this.gridAlpha, 0, 1), f = d.line(a.container, I, X, this.gridColor, f, 1, this.dashLength), f.translate(A, x), this.grid0 = f, a.axesSet.push(f), f.toBack(), d.setCN(a, f, this.bcn + "zero-grid-" + this.id), d.setCN(a, f, this.bcn + "zero-grid"))
          }
          if (!isNaN(H) && 0 <
            v && g < r - 1) {
            f = this.gridAlpha;
            this.gridAlpha = this.minorGridAlpha;
            for (A = 1; A < u / H; A++)x = this.getCoordinate(c + H * A), x = new this.axisItemRenderer(this, x, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(x);
            this.gridAlpha = f
          }
        }
        t = this.baseValue;
      ...
      for (l = this.start; l <= this.end; l++) {
        var t = 0;
        for (q = 0; q < k.length; q++)if (n = k[q], n.hidden)n.newStack && (h[l] =
      ...
      for (l = this.start; l <= this.end; l++)for (q = 0; q < k.length; q++)(n = k[q], n.hidden) ? n.newStack && (h[l] = NaN, e[l] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis ==
    ...
    getMin: function (a, b) {
      ...
      var c = {
        type: "axisZoomed",
        startValue: a, endValue: b, target: this, chart: this.chart
      };
      this.fire(c.type, c)
    }, zoomOut: function () {
      var a = this.chart;
      ...
      var c = this.chart;
      "xy" == c.type ? (b < a && (c = b, b = a, a = c), a < this.min && (a = this.min), b > this.max && (b = this.max), c = {type: "axisSelfZoomed"}, c.chart = this.chart, c.valueAxis = this, c.multiplier = this.axisWidth / Math.abs(this.getCoordinate(b) - this.getCoordinate(a)), c.startValue = a, c.endValue = b, c.position = "V" ==
      this.orientation ? this.reversed ? this.getCoordinate(a) : this.getCoordinate(b) : this.reversed ? this.getCoordinate(b) : this.getCoordinate(a), this.fire(c.type, c)) : (this.minZoom = a, this.maxZoom = b, c.updateAfterValueZoom())
    }, coordinateToValue: function (a) {
      if (isNaN(a))return NaN;
      var b = this.axisWidth, c = this.stepWidth, e = this.reversed, d = this.rotate, f = this.min, g = this.minReal;
      return !0 === this.logarithmic ? Math.pow(10, (d ? !0 === e ? (b - a) / c : a / c : !0 === e ? a / c : (b - a) / c) + Math.log(g) * Math.LOG10E) : !0 === e ? d ? f - (a - b) / c : a / c + f : d ? a / c + f : f -
      (a - b) / c
...
(function () {
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
      ...
      this.set = A;
      var v = a.axisThickness, x = a.axisColor, y = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, L = a.gridColor, H = a.dashLength, J = a.fillColor, I = a.fillAlpha, X = a.labelsEnabled;
      n = a.labelRotationR;
      ...
      g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), X = !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (L = g.lineColor), void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness), !0 === g.inside && (Q = !0, 0 < ba && (ba = 0)), isNaN(g.labelRotation) ||
      ...
      var S = n * Math.PI / 180, W, ya, E = 0, z = 0, la = 0, ga = W = 0, Ja = 0;
      "V" == Ra && (n = 0);
      var Z;
      X && "" !== c && (Z = a.autoWrap && 0 === n ? d.wrappedText(w, c, u, r, t, fa, k, Math.abs(h), 0) : d.text(w, c, u, r, t, fa, k), fa = Z.getBBox(), ga = fa.width, Ja = fa.height);
      if ("H" == Ra) {
        if (0 <= b && b <= sa + 1 && (0 < B && 0 < y && b + l <= sa + 1 && (da = d.line(w, [b + l, b + l], [0, B], x, y, C), A.push(da)), 0 < D && (ta = d.line(w, [b, b + qa, b + qa], [V, V + ka, ka], L, D, C, H), A.push(ta))), z = 0, E = b, g && 90 == n && Q && (E -= t), !1 === e ? (fa = "start", z = "bottom" == ca ? Q ? z + B : z - B : Q ? z - B : z + B, E += 3, 0 < h && (E += h / 2 - 3, fa = "middle"), 0 < n && (fa = "middle")) : fa = "middle", 1 == ea && 0 < I && !g && !m && aa < sa && (e = d.fitToBounds(b, 0, sa), aa = d.fitToBounds(aa, 0, sa), W = e - aa, 0 < W && (ya = d.rect(w, W, a.height, J, I), ya.translate(e - W + qa, ka), A.push(ya))), "bottom" == ca ? (z += V + t / 2 + ba, Q ? (0 < n ?
            (z = V - ga / 2 * Math.sin(S) - B - 3, E += ga / 2 * Math.cos(S) - 4 + 2) : 0 > n ? (z = V + ga * Math.sin(S) - B - 3 + 2, E += -ga * Math.cos(S) - Ja * Math.sin(S) - 4) : z -= B + t + 3 + 3, z -= oa) : (0 < n ? (z = V + ga / 2 * Math.sin(S) + B + 3, E -= ga / 2 * Math.cos(S)) : 0 > n ? (z = V + B + 3 - ga / 2 * Math.sin(S) + 2, E += ga / 2 * Math.cos(S)) : z += B + v + 3 + 3, z += oa)) : (z += ka + t / 2 - ba, E += qa, Q ? (0 < n ? (z = ga / 2 * Math.sin(S) + B + 3, E -= ga / 2 * Math.cos(S)) : z += B + 3, z += oa) : (0 < n ? (z = -(ga / 2) * Math.sin(S) - B - 6, E += ga / 2 * Math.cos(S)) : z -= B + t + 3 + v + 3, z -= oa)), "bottom" == ca ? W = (Q ? V - B - 1 : V + v - 1) + ba : (la = qa, W = (Q ? ka : ka - B - v + 1) - ba), f && (E += f), f = E, 0 < n &&
          (f += ga / 2 * Math.cos(S)), Z && (t = 0, Q && (t = ga / 2 * Math.cos(S)), f + t > sa + 2 || 0 > f))Z.remove(), Z = null
      } else {
        0 <= b && b <= V + 1 && (0 < B && 0 < y && b + l <= V + 1 && (da = d.line(w, [0, B + 1], [b + l, b + l], x, y, C), A.push(da)), 0 < D && (ta = d.line(w, [0, qa, sa + qa], [b, b + ka, b + ka], L, D, C, H), A.push(ta)));
        fa = "end";
        if (!0 === Q && "left" == ca || !1 === Q && "right" == ca)fa = "start";
        z = b - Ja / 2 + 2;
        1 == ea && 0 < I && !g && !m && (e = d.fitToBounds(b, 0, V), aa = d.fitToBounds(aa, 0, V), S = e - aa, ya = d.polygon(w, [0, a.width, a.width, 0], [0, 0, S, S], J, I), ya.translate(qa, e - S + ka), A.push(ya));
        z += t / 2;
        "right" == ca ?
          (E += qa + sa + ba, z += ka, Q ? (f || (z -= t / 2 + 3), E = E - (B + 4) - oa) : (E += B + 4 + v, z -= 2, E += oa)) : Q ? (E += B + 4 - ba, f || (z -= t / 2 + 3), g && (E += qa, z += ka), E += oa) : (E += -B - v - 4 - 2 - ba, z -= 2, E -= oa);
        da && ("right" == ca ? (la += qa + ba + sa, W += ka, la = Q ? la - v : la + v) : (la -= ba, Q || (la -= B + v)));
        f && (z += f);
        Q = -3;
        "right" == ca && (Q += ka);
        Z && (z > V + 1 || z < Q) && (Z.remove(), Z = null)
      }
      da && (da.translate(la, W), d.setCN(p, da, a.bcn + "tick"), d.setCN(p, da, q, !0), g && d.setCN(p, da, "guide"));
      !1 === a.visible && (da && da.remove(), Z && (Z.remove(), Z = null));
      Z && (Z.attr({"text-anchor": fa}), Z.translate(E, z,
        NaN, !0), 0 !== n && Z.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Z), this.label = Z, d.setCN(p, Z, a.bcn + "label"), d.setCN(p, Z, q, !0), g && d.setCN(p, Z, "guide"));
      ta && (d.setCN(p, ta, a.bcn + "grid"), d.setCN(p, ta, q, !0), g && d.setCN(p, ta, "guide"));
      ya && (d.setCN(p, ya, a.bcn + "fill"), d.setCN(p, ya, q, !0));
      m ? ta && d.setCN(p, ta, a.bcn + "grid-minor") : (a.counter = 0 === ea ? 1 : 0, a.previousCoord = b);
  ...
  d.AmGraph = d.Class({
    ...
    createGraph: function () {
      ...
      if (e) {
        ...
        r && f && (k.height > l.columnHeight || k.width > l.columnWidth) && (c.remove(), c = !1);
      ...
      isNaN(k) && (k = .8);
      var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, r = this.rotate, t = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), w = this.connect, A = [], v = [], x, y, B, D, C = this.chart.graphs.length, L, H = this.dx / this.tcc, J = this.dy / this.tcc, I = f.stackType, X = this.start, ea = this.end, Q = this.scrollbar, oa = "graph-column-";
      Q && (oa = "scrollbar-graph-column-");
      var qa = this.categoryAxis,
        ka = this.baseCoord, Ra = this.negativeBase, ca = this.columnIndex, aa = this.lineThickness, V = this.lineAlpha, sa = this.lineColorR, ba = this.dashLength, da = this.set, ta, fa = this.getGradRotation(), S = this.chart.columnSpacing, W = qa.cellWidth, ya = (W * k - t) / t;
      S > ya && (S = ya);
      var E, z, la, ga = q + 1, Ja = n + 1, Z = 0, qb = 0, rb, sb, eb, fb, tb = this.fillColorsR, Ka = this.negativeFillColors, Da = this.negativeLineColor, Wa = this.fillAlphas, Xa = this.negativeFillAlphas;
      ...
      if (!(Q || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
        ...
        r ? (ga = q, Ja = Math.abs(Lb - Ga) + 1, rb = q, sb = Math.abs(gb - Ga) + 1, fb = qb = 0,
          f.reversed ? (Z = 0, eb = Ga) : (Z = Ga, eb = 0)) : (Ja = n, ga = Math.abs(Lb - Ga) + 1, sb = n, rb = Math.abs(gb - Ga) + 1, eb = Z = 0, f.reversed ? (fb = p, qb = Ga) : fb = Ga + 1)
      }
      var Ha = Math.round;
      this.pmx = Ha(Z);
      this.pmy = Ha(qb);
      ...
      if ("line" == g || "step" == g || "smoothedLine" == g) {
        if (0 < X) {
          for (K =
                 X - 1; -1 < K; K--)if (E = e[K], z = E.axes[f.id].graphs[b], la = z.values.value, !isNaN(la)) {
            X = K;
            break
          }
          if (this.lineColorField)for (K = X; -1 < K; K--)if (E = e[K], z = E.axes[f.id].graphs[b], z.lineColor) {
            this.bulletColorSwitched = this.lineColorSwitched = z.lineColor;
            break
          }
          if (this.fillColorsField)for (K = X; -1 < K; K--)if (E = e[K], z = E.axes[f.id].graphs[b], z.fillColors) {
            this.fillColorsSwitched = z.fillColors;
            break
          }
          if (this.dashLengthField)for (K = X; -1 < K; K--)if (E = e[K], z = E.axes[f.id].graphs[b], !isNaN(z.dashLength)) {
            this.dashLengthSwitched = z.dashLength;
            break
          }
        }
        if (ea < e.length - 1)for (K = ea + 1; K < e.length; K++)if (E = e[K], z = E.axes[f.id].graphs[b], la = z.values.value, !isNaN(la)) {
          ea = K;
          break
        }
      }
      ...
      for (K = X; K <= ea; K++) {
        ...
        z.index = K;
        var Za, Na = NaN;
        if (m && void 0 == this.openField)for (var xb = K + 1; xb < e.length && (!e[xb] || !(Za = e[K + 1].axes[f.id].graphs[b]) || !Za.values || (Na = Za.values.value, isNaN(Na))); xb++);
        var R, P, M, ha, ma = NaN, G = NaN, F = NaN, O = NaN, N = NaN, Oa = NaN, Ea = NaN, Pa = NaN, Fa = NaN, ua = NaN, va = NaN, ia = NaN, ja = NaN, Y = NaN, yb = NaN, zb = NaN, na = NaN, pa = void 0, Ia = tb, Ta = Wa, Ba = sa, wa, za, Ab = this.proCandlesticks, kb = this.topRadius, $a = this.pattern;
        void 0 != z.pattern && ($a = z.pattern);
        isNaN(z.alpha) || (Ta = z.alpha);
        isNaN(z.dashLength) || (ba = z.dashLength);
        var Ca = z.values;
        f.recalculateToPercents && (Ca = z.percents);
        if (Ca) {
          Y = this.stackable && "none" != I && "3d" !=
          I ? Ca.close : Ca.value;
          ...
          isNaN(na) || (N = f.getCoordinate(na, ub), m && (Na = na, na = N = NaN));
          ...
          "step" !=
          g || isNaN(E.cellWidth) || (W = E.cellWidth);
          ...
          if (Nb) {
            ...
            isNaN(Bb) || (ra *= Bb, Aa *= Bb)
          }
          Q || (z.x = ma);
          -1E5 > ma && (ma = -1E5);
          ma > n + 1E5 && (ma = n + 1E5);
          r ? (G = F, O =
            N, N = F = ma, isNaN(na) && !this.fillToGraph && (O = ka), Oa = Ea, Pa = Fa) : (O = G = ma, isNaN(na) && !this.fillToGraph && (N = ka));
          ...
          var Ob = !1;
          Q && a.chartScrollbar.ignoreCustomColors && (Ob = !0);
          Ob || (void 0 != z.color && (Ia = z.color), z.fillColors && (Ia = z.fillColors));
          switch (g) {
            case "line":
              if (isNaN(Y))w || (this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = []); else {
                if (Math.abs(G -
                  hb) >= jb || Math.abs(F - ib) >= jb)A.push(G), v.push(F), hb = G, ib = F;
                ua = G;
                va = F;
                ia = G;
                ja = F;
                !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N));
                if (Ya || void 0 != z.lineColor || void 0 != z.fillColors || !isNaN(z.dashLength))this.drawLineGraph(A, v, T, U), A = [G], v = [F], T = [], U = [], !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), m ? Ma ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Da, this.fillColorsSwitched = Ka) : (this.lineColorSwitched = z.lineColor, this.fillColorsSwitched = z.fillColors), this.dashLengthSwitched =
                  z.dashLength;
            ...
            case "smoothedLine":
              if (isNaN(Y))w || (this.drawSmoothedGraph(A, v, T, U), A = [], v = [], T = [], U = []); else {
                if (Math.abs(G - hb) >= jb || Math.abs(F - ib) >= jb)A.push(G), v.push(F), hb = G, ib = F;
                ua = G;
                va = F;
                ia = G;
                ja = F;
                !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N));
                void 0 == z.lineColor && void 0 == z.fillColors && isNaN(z.dashLength) || (this.drawSmoothedGraph(A, v, T, U), A = [G], v = [F], T = [], U = [], !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), this.lineColorSwitched = z.lineColor,
                  this.fillColorsSwitched = z.fillColors, this.dashLengthSwitched = z.dashLength);
                z.gap && (this.drawSmoothedGraph(A, v, T, U), A = [], v = [], T = [], U = [])
              }
              break;
            case "step":
              if (!isNaN(Y)) {
                r ? (isNaN(x) || (A.push(x), v.push(F - ra)), v.push(F - ra), A.push(G), v.push(F + Aa), A.push(G), !La || isNaN(N) || isNaN(O) || (isNaN(B) || (T.push(B), U.push(N - ra)), T.push(O), U.push(N - ra), T.push(O), U.push(N + Aa))) : (isNaN(y) || (v.push(y), A.push(G - ra)), A.push(G - ra), v.push(F), A.push(G + Aa), v.push(F), !La || isNaN(N) || isNaN(O) || (isNaN(D) || (T.push(O - ra), U.push(D)),
                  T.push(O - ra), U.push(N), T.push(O + Aa), U.push(N)));
                x = G;
                y = F;
                B = O;
                D = N;
                ...
                if (Ya || void 0 != z.lineColor || void 0 != z.fillColors || !isNaN(z.dashLength)) {
                  ...
                  A = [bc];
                  v = [cc];
                  r ? (v.push(F + Aa), A.push(G)) : (A.push(G + Aa), v.push(F));
                  T = [];
                  U = [];
                  this.lineColorSwitched = z.lineColor;
                  this.fillColorsSwitched = z.fillColors;
                  this.dashLengthSwitched = z.dashLength;
                  m && (Ma ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched =
                    Da, this.fillColorsSwitched = Ka))
                }
                if (Nb || z.gap)x = y = NaN, this.drawLineGraph(A, v, T, U), A = [], v = [], T = [], U = []
              } else if (!w) {
                if (1 >= this.periodSpan || 1 < this.periodSpan && G - x > ra + Aa)x = y = NaN;
                this.drawLineGraph(A, v, T, U);
                A = [];
                v = [];
                T = [];
            ...
            case "column":
              wa = Ba;
              void 0 != z.lineColor && (wa = z.lineColor);
              if (!isNaN(Y)) {
                m || (z.isNegative = Y < Ra ? !0 : !1);
                z.isNegative && (Ka && (Ia = Ka), void 0 != Da && (wa = Da));
                var Pb = f.min, Qb = f.max;
                if (!(Y < Pb && na < Pb || Y > Qb && na > Qb)) {
                  var xa;
                  if (r) {
                    "3d" == I ? (P = F - (t / 2 - this.depthCount + 1) * (k + S) + S / 2 + J * ca, R = O + H *
                    ca, xa = ca) : (P = Math.floor(F - (t / 2 - ca) * (k + S) + S / 2), R = O, xa = 0);
                    M = k;
                    ua = G;
                    va = P + k / 2;
                    isNaN(O) || O > G && !z.isNegative && (ua = O);
                    ia = G;
                    ja = P + k / 2;
                    P + M > q + xa * J && (M = q - P + xa * J);
                    P < xa * J && (M += P, P = xa * J);
                    ha = G - O;
                    var dc = R;
                    ...
                    isNaN(E.percentWidthValue) || (M = this.height * E.percentWidthValue / 100, P = wb, wb += M, va = P + M / 2);
                    P < q && 0 < M && (pa = new d.Cuboid(h, ha, M, H - a.d3x, J - a.d3y, Ia, Ta, aa, wa, V, fa, u, r, ba, $a, kb, oa), z.columnWidth = Math.abs(ha), z.columnHeight = Math.abs(M))
                  } else {
                    "3d" == I ? (R = G - (t /
                    2 - this.depthCount + 1) * (k + S) + S / 2 + H * ca, P = N + J * ca, xa = ca) : (R = G - (t / 2 - ca) * (k + S) + S / 2, P = N, xa = 0);
                    M = k;
                    ua = R + k / 2;
                    va = F;
                    isNaN(N) || N < F && !z.isNegative && !f.reversed && (va = N);
                    ia = R + k / 2;
                    ja = F;
                    R + M > n + xa * H && (M = n - R + xa * H);
                    R < xa * H && (M += R - xa * H, R = xa * H);
                    ha = F - N;
                    var ec = P;
                    P = d.fitToBounds(P, this.dy, q);
                    ha += ec - P;
                    ha = d.fitToBounds(ha, -P + J * ca, q - P);
                    isNaN(E.percentWidthValue) || (M = this.width * E.percentWidthValue / 100, R = vb, vb += M, ua = R + M / 2);
                    R < n + ca * H && 0 < M && (this.showOnAxis && (P -= J / 2), pa = new d.Cuboid(h, M, ha, H - a.d3x, J - a.d3y, Ia, Ta, aa, wa, this.lineAlpha,
                      fa, u, r, ba, $a, kb, oa), z.columnHeight = Math.abs(ha), z.columnWidth = Math.abs(M))
                  }
                }
                if (pa && (za = pa.set, d.setCN(a, pa.set, "graph-" + this.type), d.setCN(a, pa.set, "graph-" + this.id), z.className && d.setCN(a, pa.set, z.className, !0), z.columnGraphics = za, za.translate(R, P), this.columnsSet.push(za), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), !Q)) {
                  "none" == I && (L = r ? (this.end + 1 - K) * C - c : C * K + c);
                  "3d" == I && (r ? (L = (this.end + 1 - K) * C - c - 1E3 * this.depthCount, ua += H * this.columnIndex, ia += H * this.columnIndex, z.y += H * this.columnIndex) :
                    (L = (C - c) * (K + 1) + 1E3 * this.depthCount, va += J * this.columnIndex, ja += J * this.columnIndex, z.y += J * this.columnIndex));
                  if ("regular" == I || "100%" == I)L = r ? 0 < Ca.value ? (this.end + 1 - K) * C + c : (this.end + 1 - K) * C - c : 0 < Ca.value ? C * K + c : C * K - c;
            ...
            case "candlestick":
              if (!isNaN(na) && !isNaN(Y)) {
                ...
                void 0 != z.lineColor && (wa = z.lineColor);
                if (r) {
                  if (P = F - k / 2, R = O, M = k, P + M > q && (M = q - P),
                    0 > P && (M += P, P = 0), P < q && 0 < M) {
                    var Cb, Db;
                    Y > na ? (Cb = [G, Pa], Db = [O, Oa]) : (Cb = [O, Pa], Db = [G, Oa]);
                    !isNaN(Pa) && !isNaN(Oa) && F < q && 0 < F && (Va = d.line(h, Cb, [F, F], wa, V, aa), ab = d.line(h, Db, [F, F], wa, V, aa));
                    ha = G - O;
                  ...
                  Ab && Y >= na && (Ta = 0);
                  var pa = new d.Cuboid(h, M, ha, H, J, Ia, Ta, aa, wa, V, fa, u, r, ba, $a, kb, oa), Eb, Fb;
                  Y > na ? (Eb = [F, Fa], Fb = [N, Ea]) : (Eb = [N, Fa], Fb = [F, Ea]);
                  !isNaN(Fa) && !isNaN(Ea) && G < n && 0 < G && (Va =
                    d.line(h, [G, G], Eb, wa, V, aa), ab = d.line(h, [G, G], Fb, wa, V, aa), d.setCN(a, Va, this.bcn + "line-high"), z.className && d.setCN(a, Va, z.className, !0), d.setCN(a, ab, this.bcn + "line-low"), z.className && d.setCN(a, ab, z.className, !0))
                }
                pa && (za = pa.set, z.columnGraphics = za, da.push(za), za.translate(R, P - aa / 2), (z.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), Va && (da.push(Va), da.push(ab)), ua = G, va = F, r ? (ja = F, ia = G, "open" == l && (ia = O), "high" == l && (ia = Pa), "low" == l && (ia = Oa)) : (ja = F, "open" == l && (ja = N), "high" == l && (ja = Fa), "low" ==
                l && (ja = Ea), ia = G), Q || (z.x = r ? P + M / 2 : R + M / 2, this.animateColumns(pa, K, G, O, F, N), this.addListeners(za, z)))
              }
              break;
            case "ohlc":
              if (!(isNaN(na) || isNaN(yb) || isNaN(zb) || isNaN(Y))) {
                ...
                if (r) {
                  ...
                  nb = d.line(h, [O, O], [Gb, Sb], Ba, V, aa, ba);
                  0 < F && F < q && (mb = d.line(h, [Oa, Pa], [F, F], Ba, V, aa, ba));
                  ob = d.line(h, [G, G], [Sb, Hb], Ba, V, aa, ba);
                  ja = F;
                  ia = G;
                  "open" == l && (ia =
                    O);
                  ...
                  var Ib = G - k / 2, Ib = d.fitToBounds(Ib, 0, n), Tb = d.fitToBounds(G, 0, n), Jb = G + k / 2, Jb = d.fitToBounds(Jb, 0, n);
          ...
          if (!Q && !isNaN(Y)) {
            ...
            if (this.end - this.start <= Ub || 0 === Ub) {
              var Vb = this.createBullet(z, ia, ja, K), Wb = this.labelText;
              if (Wb && Vb) {
                var Kb = this.createLabel(z, ia, ja, Wb);
                (Kb = this.positionLabel(ua, va, Kb, Vb, M, ha)) && this.allBullets.push(Kb)
              }
              if ("regular" == I || "100%" == I) {
                var Xb = f.totalText;
                if (Xb) {
                  ...
                  var Yb = Qa.getBBox(), Zb = Yb.width, $b = Yb.height, bb, cb, pb = f.totalTextOffset,
                    ac = f.totals[K];
                  ac && ac.remove();
                  var db = 0;
                  "column" != g && (db = this.bulletSize);
                  r ? (cb = va, bb = 0 > Y ? G - Zb / 2 - 2 - db - pb : G + Zb / 2 + 3 + db + pb) : (bb = ua, cb = 0 > Y ? F + $b / 2 + db + pb : F - $b / 2 - 3 - db - pb);
                  Qa.translate(bb, cb);
                  f.totals[K] = Qa;
      ...
      if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(A, v, T, U) : this.drawLineGraph(A, v, T, U), Q || this.launchAnimation();
      ...
      k && (e = k(a, e));
      a = d.text(this.container, e, g, f.fontFamily,
        h);
      ...
      if (1 < a.length) {
        ...
        g.push(n);
        g.push(m);
        var q = h.lineAlpha, p = h.lineThickness, g = h.fillAlphas, r = h.lineColorR, t = h.negativeLineAlpha;
        isNaN(t) && (t = q);
        ...
        if (0 < g || 0 < x)if (p = a.join(";").split(";"), t = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), t = b.concat(e)) : "radar" == q ? (t.push(0), p.push(0)) : h.rotate ? (t.push(t[t.length - 1]), p.push(y), t.push(t[0]), p.push(y), t.push(t[0]), p.push(p[0])) :
            (p.push(p[p.length - 1]), t.push(y), p.push(p[0]), t.push(y), p.push(a[0]), t.push(t[0])) : "xy" == q && (b = h.fillToAxis) && (d.isString(b) && (b = k.getValueAxisById(b)), "H" == b.orientation ? (y = "top" == b.position ? 0 : b.viH, p.push(p[p.length - 1]), t.push(y), p.push(p[0]), t.push(y), p.push(a[0]), t.push(t[0])) : (y = "left" == b.position ? 0 : b.viW, t.push(t[t.length - 1]), p.push(y), t.push(t[0]), p.push(y), t.push(t[0]), p.push(p[0]))), a = h.gradientRotation, 0 < g && (b = d.polygon(l, p, t, u, g, 1, "#000", 0, a, f), b.pattern(h.pattern, NaN, k.path), d.setCN(k,
            b, h.bcn + "fill"), m.push(b)), v || void 0 !== w)isNaN(x) && (x = g), v || (v = w), f = d.polygon(l, p, t, v, x, 1, "#000", 0, a, f), d.setCN(k, f, h.bcn + "fill"), d.setCN(k, f, h.bcn + "fill-negative"), f.pattern(h.pattern, NaN, k.path), n.push(f), n.click(function (a) {
          h.handleGraphEvent(a, "clickGraph")
        }).mouseover(function (a) {
      ...
      if (1 < a.length) {
        ...
        0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), p = b.concat(e)) : (this.rotate ? (n += " L" + A + "," + b[b.length - 1], n += " L" + A + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + A, n += " L" + a[0] + "," + A), n += " L" + a[0] + "," + b[0]), c = new d.Bezier(g, m, p, NaN,
          0, 0, r, q, h, n), d.setCN(f, c, this.bcn + "fill"), c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== t) && (w || (w = q), u || (u = t), a = new d.Bezier(g, a, b, NaN, 0, 0, u, w, h, n), a.path.pattern(this.pattern, NaN, f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"), l.push(a.path));
        this.applyMask(l, k)
      }
      ...
      if (!isNaN(b) && !isNaN(c)) {
        ...
        p ? (p.size =
          g || 0, a.bulletGraphics = p) : p = {size: 0};
        p.graphDataItem = a;
        return p
      }
    ...
    construct: function (a) {
      ...
      if (this.enabled) {
        ...
        var k = e.categoryAxis,
          l = e.dx, m = e.dy, n = this.x + 1, q = this.y + 1, p = this.width, r = this.height, t = this.data[a], u;
        this.data[a + 1] && (u = this.data[a + 1]);
        this.fireMoved();
        if (t) {
          var w = t.x[k.id], A = e.rotate, v = this.stepWidth, x = this.categoryBalloon, y = this.firstTime, B = this.lastTime, D = this.cursorPosition, C = this.zooming, L = this.panning, H = e.graphs;
          if (e.mouseIsOver || C || L || this.forceShow)if (this.forceShow = !1, L) {
            b = this.panClickPos;
            a = this.panClickEndTime;
            var e = this.panClickStartTime, C = this.panClickEnd, J = this.panClickStart, f = (A ? b - g : b - f) / v;
            if (!k.parseDates ||
              k.equalSpacing)f = Math.round(f);
            0 !== f && (b = {
              type: "zoomed",
              target: this
            }, b.chart = this.chart, k.parseDates && !k.equalSpacing ? (a + f > B && (f = B - a), e + f < y && (f = y - e), b.start = Math.round(e + f), b.end = Math.round(a + f), this.fire(b.type, b)) : C + f >= this.data.length || 0 > J + f || (b.start = J + f, b.end = C + f, this.fire(b.type, b)))
          } else {
            "start" == D ? w -= k.cellWidth / 2 : "mouse" == D && (e.mouseIsOver ? w = A ? g - 2 : f - 2 : isNaN(this.tempPosition) || (w = this.tempPosition - 2));
            if (A) {
            ...
            y = this.line;
            0 < this.cursorAlpha && (A ? (B = 0, v = w + m, h && (v -= k.cellWidth / 2)) : (B = w, v = 0, h && (B -= k.cellWidth / 2)), D = this.animationDuration, 0 < D && !this.zooming ? isNaN(this.previousX) ? y.translate(B, v) : (y.translate(this.previousX, this.previousY), y.animate({translate: B + "," + v}, D, "easeOutSine")) : y.translate(B, v), this.previousX = B, this.previousY = v, y.show());
            this.linePos = A ? w + m : w;
            C && (h && y.hide(), A ? this.updateSelectionSize(NaN,
              w) : this.updateSelectionSize(w, NaN));
            B = !0;
            C && (B = !1);
            this.categoryBalloonEnabled && B && (this.setBalloonPosition(x, k, w, A), (y = this.categoryBalloonFunction) ? x.showBalloon(y(t.category)) : (y = w = "", k.parseDates ? (w = d.formatDate(t.category, this.categoryBalloonDateFormat, e), k = d.changeDate(new Date(t.category), e.categoryAxis.minPeriod, 1), y = d.formatDate(k, this.categoryBalloonDateFormat, e), -1 != w.indexOf("fff") && (w = d.formatMilliseconds(w, t.category), y = d.formatMilliseconds(y, k))) : (w = d.fixNewLines(t.category), u && (y =
              d.fixNewLines(u.category))), k = this.categoryBalloonText.replace(/\[\[category\]\]/g, String(w)), k = k.replace(/\[\[toCategory\]\]/g, String(y)), x.showBalloon(k)));
            H && this.bulletsEnabled && this.showBullets();
            if (this.oneBalloonOnly) {
              w = Infinity;
              for (k = 0; k < H.length; k++)x = H[k], x.showBalloon && !x.hidden && x.balloonText && (u = t.axes[x.valueAxis.id].graphs[x.id], y = u.y, "top" == x.showBalloonAt && (y = 0), "bottom" == x.showBalloonAt && (y = this.height), isNaN(y) || (A ? Math.abs(f - y) < w && (w = Math.abs(f - y), J = x) : Math.abs(g - y) < w && (w = Math.abs(g -
              y), J = x)));
            ...
            if (!c && (a != this.previousIndex || J != this.previousMostCloseGraph) && (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], H && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
              ...
              for (k = 0; k < H.length; k++)if (x = H[k], y = NaN, (!this.oneBalloonOnly || x == J) && x.showBalloon && !x.hidden && x.balloonText && ("step" == x.type && "left" == x.stepDirection && (t = this.data[a + 1]), t)) {
      ...
      var e = b.position, d = b.inside,
        f = b.axisThickness, g = b.tickLength, k = this.chart, l = k.dx, k = k.dy, m = this.x, n = this.y, q = this.width, p = this.height;
        ...
        if (this.enabled && 0 < b.length) {
          if (this.pan)this.rolledOver = !1; else if (this.zoomable && this.zooming) {
            ...
            if ("cursor" ==
              ...
              (b = Math.min(g, e), f = Math.min(k, h), e = Math.abs(g - e), h = Math.abs(k - h), a.hideXScrollbar && (b = 0, e = this.width), a.hideYScrollbar && (f = 0, h = this.height), c.selectionHeight = h, c.selectionWidth = e, c.selectionY = f, c.selectionX = b, this.skipZoomDispatch || this.fire(c.type, c))
            }
      ...
      if (this.zoomable || this.pan || this.drawing) {
        ...
        if (0 < e && e < this.width && 0 < h && h < this.height || "fake" == a)this.setPosition(), this.selectWithoutZooming && d.remove(this.selection), this.drawing ? (this.drawStartY = h, this.drawStartX = e, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos =
          b ? h : e, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime) : this.zoomable && ("cursor" == this.type ? (this.fromIndex = this.index, b ? (this.initialMouse = h, this.selectionPosY = this.linePos) : (this.initialMouse = e, this.selectionPosX = this.linePos)) : (this.initialMouseX = e, this.initialMouseY = h, this.selectionPosX = e, this.selectionPosY = h), this.zooming = !0)
      }
    }
  })
})();
    ...
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          !isNaN(D) && C < D && (C = D);
          window.opera && (x += 2);
          var L = !1, y = this.offsetY;
          c.handDrawn && (y += c.handDrawScatter + 2);
          "H" != A ? (D = a - C / 2, b < k + x + 10 && "down" != A ? (L = !0, e && (b += y), y = b + w, this.deltaSignY = -1) : (e && (b -= y), y = b - x - w, this.deltaSignY = 1)) : (2 * w > x && (w = x / 2), y = b - x / 2, a < g + (l - g) / 2 ? (D = a + w, this.deltaSignX = -1) : (D = a - C - w, this.deltaSignX = 1));
          y + x >= m && (y = m - x);
          y < k && (y = k);
          D < g && (D = g);
          D + C > l && (D = l - C);
          var k = y + u, m = D + t, u = this.shadowAlpha, H = this.shadowColor, t = this.borderThickness, J = this.bulletSize, I;
          0 < v || 0 === w ? (0 < u && (a = d.rect(h,
            C, x, q, 0, t + 1, H, u, this.cornerRadius), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), q = d.rect(h, C, x, q, this.fillAlpha, t, p, this.borderAlpha, this.cornerRadius), this.showBullet && (I = d.circle(h, J, r, this.fillAlpha), f.push(I))) : (r = [], v = [], "H" != A ? (g = a - D, g > C - w && (g = C - w), g < w && (g = w), r = [0, g - w, a - D, g + w, C, C, 0, 0], v = L ? [0, 0, b - y, 0, 0, x, x, 0] : [x, x, b - y, x, x, 0, 0, x]) : (r = b - y, r > x - w && (r = x - w), r < w && (r = w), v = [0, r - w, b - y, r + w, x, x, 0, 0], r = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < u && (a = d.polygon(h, r, v, q,
            0, t, H, u), a.translate(1, 1), f.push(a)), q = d.polygon(h, r, v, q, this.fillAlpha, t, p, this.borderAlpha));
          this.bg = q;
          f.push(q);
          q.toFront();
          ...
          for (D = 0; D < B.length; D++) {
            ...
            for (L = 0; L < b.length; L++) {
              ...
              if (c.valueAxis.id == C) {
                ...
                var ea = y;
                c.dataProvider && (ea = e);
                X.values = this.processValues(ea, c, I);
                !c.connect && v && v[H] && 0 < J && x.time - r[H] >= t * J && (v[H].gap = !0);
                this.processFields(c, X, ea);
...
(function () {
  ...
  d.bullet = function (a, b, c, e, h, f, g, k, l, m, n, q) {
    ...
    switch (b) {
      ...
      case "rectangle":
        p = d.polygon(a, [-c, c, c,
          -c], [c / 2, c / 2, -c / 2, -c / 2], e, h, f, g, k, m - 180);
        break;
      case "diamond":
  ...
  d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p) {
    ...
    359.94 < w && (w = 359.94);
    h >= w && (h = w);
    var A = 1 / 180 * Math.PI, w =
      b + Math.sin(e * A) * k, v = c - Math.cos(e * A) * t, x = b + Math.sin(e * A) * f, y = c - Math.cos(e * A) * g, B = b + Math.sin((e + h) * A) * f, D = c - Math.cos((e + h) * A) * g, C = b + Math.sin((e + h) * A) * k, A = c - Math.cos((e + h) * A) * t, L = {
    ...
    e = a.set();
    var J;
    u && (w = r(10 * w), x = r(10 * x), B = r(10 * B), C = r(10 * C), v = r(10 * v), y = r(10 * y), D = r(10 * D), A = r(10 * A), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, t *= 10, 1 > Math.abs(h) && 1 >= Math.abs(B - x) && 1 >= Math.abs(D - y) && (J = !0));
    h = "";
    var I;
    q && (L["fill-opacity"] = 0, L["stroke-opacity"] = m["stroke-opacity"] / 2, L.stroke = m.stroke);
    if (0 < l) {
      I = " M" + w + "," + (v + l) + " L" + x + "," + (y + l);
      u ? (J || (I += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + x + "," + (y + l) + "," + B + "," + (D + l)), I += " L" + C + "," + (A + l), 0 < k && (J || (I += " B" + (b - k) + "," + (l + c - t) + "," + (b + k) + "," + (l + c + t) + "," + C + "," + (l + A) + "," + w + "," + (l + v)))) : (I += " A" + f + "," + g + ",0," + H + ",1," + B + "," + (D + l) + " L" + C + "," + (A + l), 0 < k && (I += " A" + k + "," + t + ",0," + H + ",0," + w + "," + (v + l)));
      I += " Z";
      var X = l;
      u && (X /= 10);
      for (var ea = 0; ea < X; ea +=
        10) {
        var Q = a.path(I, void 0, void 0, "1000,1000").attr(L);
        e.push(Q);
        Q.translate(0, -ea)
      }
      I = a.path(" M" + w + "," + v + " L" + w + "," + (v + l) + " L" + x + "," + (y + l) + " L" + x + "," + y + " L" + w + "," + v + " Z", void 0, void 0, "1000,1000").attr(L);
      l = a.path(" M" + B + "," + D + " L" + B + "," + (D + l) + " L" + C + "," + (A + l) + " L" + C + "," + A + " L" + B + "," + D + " Z", void 0, void 0, "1000,1000").attr(L);
      e.push(I);
      e.push(l)
    }
    u ? (J || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(x) + "," + r(y) + "," + r(B) + "," + r(D)), f = " M" + r(w) + "," + r(v) + " L" + r(x) + "," + r(y) + h + " L" + r(C) + "," + r(A)) : f =
      " M" + w + "," + v + " L" + x + "," + y + (" A" + f + "," + g + ",0," + H + ",1," + B + "," + D) + " L" + C + "," + A;
    0 < k && (u ? J || (f += " B" + (b - k) + "," + (c - t) + "," + (b + k) + "," + (c + t) + "," + C + "," + A + "," + w + "," + v) : f += " A" + k + "," + t + ",0," + H + ",0," + w + "," + v);
...
(function () {
  ...
  d.AmLegend = d.Class({
    construct: function (a) {
      ...
      for (x = 0; x < A.length; x++) {
        var L = A[x];
        this.reversedOrder && (L = A[A.length - x - 1]);
        v = L.getBBox();
        var H;
        this.equalWidths ? H = y * (p + n + this.markerLabelGap) : (H = B, B = B + v.width + f + n);
        v.height > C && (C =
          v.height);
        H + v.width > q && 0 < x && 0 !== y && (r++, H = y = 0, B = H + v.width + f + n, D = D + C + m, C = 0);
        L.translate(H, D);
        y++;
