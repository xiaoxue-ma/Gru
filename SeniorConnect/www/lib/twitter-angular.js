/**
 * Created by Siyao on 2015/4/27.
 */

angular.module('twitterLib', [])

    .factory('TwitterLib', function ($rootScope, $q, $window, $http, twitterConfig) {
        ...
        options = angular.extend({}, twitterConfig.oauthSettings);
        ...
        $window.document.addEventListener("deviceready", function () {
            ...
            callbackURL = twitterConfig.oauthSettings.callbackUrl;
